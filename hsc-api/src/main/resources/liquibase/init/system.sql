...
-- changeset hsc:init-system
-- comment 项目首次部署：全量建库脚本（49 张表 + 初始数据），空库执行一次即纳入版本管理
SET NAMES utf8mb4;
...
-- IF NOT EXISTS：归属地号段表由 mysql initdb.d（deploy/phone_location.sql）在 backend 启动前预建并灌数，此处幂等跳过
