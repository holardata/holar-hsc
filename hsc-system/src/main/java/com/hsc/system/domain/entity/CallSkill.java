...
public class CallSkill extends BaseEntity implements Serializable {
    ...
    /**
     * 溢出策略 0-挂机 1-转IVR 2-转技能组 3-转AI坐席
     */
    @Schema(description = "溢出策略 0-挂机 1-转IVR 2-转技能组 3-转AI坐席")
    ...
    /**
     * 排队播报音（排队期间每30s插播一次，voice_file.id）
     */
    @Schema(description = "排队播报音")
    @TableField("queue_announce_voice")
    private Long queueAnnounceVoice;
