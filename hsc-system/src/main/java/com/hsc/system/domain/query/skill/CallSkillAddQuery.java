...
package com.hsc.system.domain.query.skill;
...
public class CallSkillAddQuery {
     ...
     */
    @Schema(description = "溢出策略 0-挂机 1-转IVR 2-转技能组 3-转AI坐席", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "成员列表(坐席memberType=0 + 座机memberType=1，至少填一项)")
