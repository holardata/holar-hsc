 ...
 */
@Slf4j
@EslEventName(EslEventNames.CHANNEL_DESTROY)
@Component
public class FsChannelDestroyEslEventHandler extends AbstractFsEslEventHandler {

    @Override
    public void handleEslEvent(String address, EslEvent event) {
        //log.info("ChannelDestroyEslEventHandler  EslEvent:{}.", JSONObject.toJSONString(event));
    }
}
