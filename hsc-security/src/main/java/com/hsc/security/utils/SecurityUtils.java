...
package com.hsc.security.utils;
 ...
 **/
public class SecurityUtils extends com.hsc.common.utils.SecurityUtils {
    ...
    /**
     * 是否超管：userId==1 或 数据范围含"全部数据"(1)。
     * 统一约定，供 @DataScope 切面与 Controller 共用。
     */
    public static boolean isAdmin() {
        ...
        List<Integer> dataScope = getDataScope();
        return dataScope != null && dataScope.contains(1);
    }
}
