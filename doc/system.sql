-- ============================================================================
-- ⚠️  已废弃（DEPRECATED）—— 请勿据此分析当前数据库
-- 此文件为 hsc-backend 早期的一次性数据库 dump 快照（建表 + 初始 INSERT），
-- 其中的菜单 path、初始数据等已与当前真实数据库脱节（如 sys_menu 菜单 path
-- 已随前端重构更新，此处仍是旧值）。不要用它来判断线上表结构或数据。
--
-- ✅ 当前数据库 schema 由 Liquibase 管理，迁移脚本（权威来源）位于：
--    hsc-api/src/main/resources/liquibase/
--      ├─ changelog-master.xml   主入口
--      ├─ ddl/changelog-ddl.sql  建表（DDL）
--      └─ dml/changelog-dml.sql  初始数据（DML，含菜单等）
-- 查/改表结构与初始数据，请以 liquibase 目录为准，勿用本文件。
-- 废弃日期：2026-07-22
-- ============================================================================

SET NAMES utf8mb4;

-- holarSmartCall.call_display definition
...
-- holarSmartCall.call_display_pool definition
...
-- holarSmartCall.call_display_pool_rel definition
...
-- holarSmartCall.call_engine definition
...
-- holarSmartCall.call_in_phone definition
...
-- holarSmartCall.call_in_phone_rel definition
...
-- holarSmartCall.call_record definition
...
-- holarSmartCall.call_route definition
...
-- holarSmartCall.call_schedule definition
...
-- holarSmartCall.call_skill definition
...
-- holarSmartCall.call_skill_agent_rel definition
...
-- holarSmartCall.call_task definition
...
-- holarSmartCall.call_task_assignment definition
...
-- holarSmartCall.customer_crowd definition
...
-- holarSmartCall.customer_crowd_rel definition
...
-- holarSmartCall.customer_field definition
...
-- holarSmartCall.customer_seas definition
...
-- holarSmartCall.customer_template definition
...
-- holarSmartCall.customer_template_field_rel definition
...
-- holarSmartCall.flow_info definition
...
-- holarSmartCall.flow_instances definition
...
-- holarSmartCall.flow_node_execution_history definition
...
-- holarSmartCall.fs_acl definition
...
-- holarSmartCall.fs_cdr definition
...
-- holarSmartCall.fs_config definition
...
-- holarSmartCall.fs_dialplan definition
...
-- holarSmartCall.fs_modules definition
...
-- holarSmartCall.fs_sip_gateway definition
...
-- holarSmartCall.ko_acc definition
...
-- holarSmartCall.ko_address definition
...
-- holarSmartCall.ko_dispatcher definition
...
-- holarSmartCall.ko_location definition
...
-- holarSmartCall.ko_subscriber definition
...
-- holarSmartCall.area_code definition
...
-- holarSmartCall.region definition
...
-- holarSmartCall.phone_location definition
...
-- holarSmartCall.sip_agent definition
...
-- holarSmartCall.sys_category definition
...
-- holarSmartCall.sys_dept definition
...
-- holarSmartCall.sys_file definition
...
-- holarSmartCall.sys_menu definition
...
-- holarSmartCall.sys_oper_log definition
...
-- holarSmartCall.sys_role definition
...
-- holarSmartCall.sys_role_menu definition
...
-- holarSmartCall.sys_user definition
...
-- holarSmartCall.sys_user_dept definition
...
-- holarSmartCall.sys_user_role definition
...
-- holarSmartCall.version definition
...
-- holarSmartCall.voice_file definition
...
(4,'外呼任务',0,4,'#',NULL,1,'M',0,0,NULL,'UnorderedListOutlined','外呼任务目录',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(5,'客户管理',0,5,'#',NULL,1,'M',0,0,NULL,'AppstoreOutlined','客户管理目录',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(6,'IVR管理',0,6,'#',NULL,1,'M',0,0,NULL,'AppstoreOutlined','IVR管理目录',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(7,'机器人配置',0,7,'#',NULL,1,'M',0,0,NULL,'AppstoreOutlined','机器人配置目录',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- ========== 系统管理 子菜单 ==========
...
(308,'话单管理',3,9,'/callRecordManagement',NULL,1,'C',0,0,NULL,'','话单管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(309,'AI引擎管理',3,10,'/aiEngineManagement',NULL,1,'C',0,0,NULL,'','AI引擎管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- ========== 外呼任务 子菜单 ==========
(400,'任务管理',4,1,'/callTaskManagement',NULL,1,'C',0,0,NULL,'','任务管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- ========== 客户管理 子菜单 ==========
(500,'客户模板',5,1,'/custoemrTemplateManagement',NULL,1,'C',0,0,NULL,'','客户模板',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(501,'客户字段',5,2,'/customerFieldManagement',NULL,1,'C',0,0,NULL,'','客户字段',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(502,'客户公海',5,3,'/customerSeasManagement',NULL,1,'C',0,0,NULL,'','客户公海',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(503,'客户人群',5,4,'/customerCrowdManagement',NULL,1,'C',0,0,NULL,'','客户人群',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- ========== IVR管理 子菜单 ==========
(600,'IVR管理',6,1,'/ivrManagement',NULL,1,'C',0,0,NULL,'','IVR管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- ========== 机器人配置 子菜单 ==========
(700,'意图管理',7,1,'/intentManagement',NULL,1,'C',0,0,NULL,'','意图管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(701,'大模型引擎管理',7,2,'/modelEngineManagement',NULL,1,'C',0,0,NULL,'','大模型引擎管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(702,'知识库管理',7,3,'/knowledgeManagement',NULL,1,'C',0,0,NULL,'','知识库管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(703,'机器人管理',7,4,'/robotManagement',NULL,1,'C',0,0,NULL,'','机器人管理',1,'2024-07-15 10:43:17.0',NULL,NULL,0);

-- ========== 按钮权限（F类型） ==========
INSERT INTO sys_menu (menu_id,menu_name,parent_id,order_num,`path`,component,is_frame,menu_type,visible,status,perms,icon,remark,create_by,create_time,update_by,update_time,del_flag) VALUES
-- 用户管理按钮
(1001,'新增用户',100,1,'#',NULL,1,'F',0,0,'system:user:add','','新增用户按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1002,'修改用户',100,2,'#',NULL,1,'F',0,0,'system:user:edit','','修改用户按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1003,'修改密码',100,3,'#',NULL,1,'F',0,0,'system:user:editPassWord','','修改密码按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1004,'删除用户',100,4,'#',NULL,1,'F',0,0,'system:user:delete','','删除用户按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1005,'用户详情',100,5,'#',NULL,1,'F',0,0,'system:user:get','','用户详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1006,'用户列表',100,6,'#',NULL,1,'F',0,0,'system:user:list','','用户列表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- 角色管理按钮
(1007,'新增角色',101,1,'#',NULL,1,'F',0,0,'system:role:add','','新增角色按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1008,'修改角色',101,2,'#',NULL,1,'F',0,0,'system:role:edit','','修改角色按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1009,'角色详情',101,3,'#',NULL,1,'F',0,0,'system:role:get','','角色详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1010,'删除角色',101,4,'#',NULL,1,'F',0,0,'system:role:delete','','删除角色按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1011,'角色列表',101,5,'#',NULL,1,'F',0,0,'system:role:list','','角色列表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- 菜单管理按钮
(1012,'新增菜单',102,1,'#',NULL,1,'F',0,0,'system:menu:add','','新增菜单按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1013,'修改菜单',102,2,'#',NULL,1,'F',0,0,'system:menu:edit','','修改菜单按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1014,'菜单详情',102,3,'#',NULL,1,'F',0,0,'system:menu:get','','菜单详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1015,'删除菜单',102,4,'#',NULL,1,'F',0,0,'system:menu:delete','','删除菜单按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1016,'菜单列表',102,5,'#',NULL,1,'F',0,0,'system:menu:list','','菜单列表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- 日志管理按钮
(1017,'日志列表',103,1,'#',NULL,1,'F',0,0,'system:log:list','','日志列表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1018,'删除日志',103,2,'#',NULL,1,'F',0,0,'system:log:delete','','删除日志按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1019,'清空日志',103,3,'#',NULL,1,'F',0,0,'system:log:empty','','清空日志按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- FS配置管理按钮
(1025,'新增FS配置',200,1,'#',NULL,1,'F',0,0,'system:fs:add','','新增fs配置按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1026,'修改FS配置',200,2,'#',NULL,1,'F',0,0,'system:fs:edit','','修改fs配置按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1027,'fs配置详情',200,3,'#',NULL,1,'F',0,0,'system:fs:get','','fs配置详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1028,'删除fs配置',200,4,'#',NULL,1,'F',0,0,'system:fs:delete','','删除fs配置按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1029,'fs配置列表(分页)',200,5,'#',NULL,1,'F',0,0,'system:fs:page:list','','fs配置列表(分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1030,'fs配置列表(不分页)',200,6,'#',NULL,1,'F',0,0,'system:fs:list','','fs配置列表(不分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- FS模块配置按钮
(1031,'新增FS模块',201,1,'#',NULL,1,'F',0,0,'system:fs:modules:add','','新增FS模块按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1032,'修改FS模块',201,2,'#',NULL,1,'F',0,0,'system:fs:modules:edit','','修改FS模块按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1033,'FS模块详情',201,3,'#',NULL,1,'F',0,0,'system:fs:modules:get','','FS模块详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1034,'删除FS模块',201,4,'#',NULL,1,'F',0,0,'system:fs:modules:delete','','删除FS模块按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1035,'FS模块配置列表(分页)',201,5,'#',NULL,1,'F',0,0,'system:fs:modules:page:list','','FS模块配置列表(分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1036,'FS模块配置列表(不分页)',201,6,'#',NULL,1,'F',0,0,'system:fs:modules:list','','FS模块配置列表(不分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- FS网关按钮
(1037,'新增FS网关',202,1,'#',NULL,1,'F',0,0,'system:fs:gateway:add','','新增FS网关按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1038,'修改FS网关',202,2,'#',NULL,1,'F',0,0,'system:fs:gateway:edit','','修改FS网关按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1039,'FS网关详情',202,3,'#',NULL,1,'F',0,0,'system:fs:gateway:get','','FS网关详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1040,'删除FS网关',202,4,'#',NULL,1,'F',0,0,'system:fs:gateway:delete','','删除FS网关按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1041,'FS网关列表(分页)',202,5,'#',NULL,1,'F',0,0,'system:fs:gateway:page:list','','FS网关列表(分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1042,'FS网关列表(不分页)',202,6,'#',NULL,1,'F',0,0,'system:fs:gateway:list','','FS网关列表(不分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- FS访问控制按钮
(1043,'新增acl规则表',203,1,'#',NULL,1,'F',0,0,'system:acl:table:add','','新增acl规则表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1044,'新增acl规则',203,2,'#',NULL,1,'F',0,0,'system:acl:node:add','','新增acl规则按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1045,'修改acl规则表',203,3,'#',NULL,1,'F',0,0,'system:acl:list:edit','','修改acl规则表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1046,'修改acl规则',203,4,'#',NULL,1,'F',0,0,'system:acl:node:edit','','修改acl规则按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1047,'acl规则详情',203,5,'#',NULL,1,'F',0,0,'system:acl:get','','acl规则详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1048,'删除acl',203,6,'#',NULL,1,'F',0,0,'system:acl:delete','','删除acl按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1049,'acl列表(分页)',203,7,'#',NULL,1,'F',0,0,'system:acl:page:list','','acl列表(分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1050,'acl列表(不分页)',203,8,'#',NULL,1,'F',0,0,'system:acl:list','','acl列表(不分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- FS拨号计划按钮
(1051,'新增拨号计划',204,1,'#',NULL,1,'F',0,0,'system:dialplan:add','','新增拨号计划按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1052,'修改拨号计划',204,2,'#',NULL,1,'F',0,0,'system:dialplan:edit','','修改拨号计划按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1053,'拨号计划详情',204,3,'#',NULL,1,'F',0,0,'system:dialplan:get','','拨号计划详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1054,'删除拨号计划',204,4,'#',NULL,1,'F',0,0,'system:dialplan:delete','','删除拨号计划按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1055,'拨号计划列表(分页)',204,5,'#',NULL,1,'F',0,0,'system:dialplan:page:list','','拨号计划列表(分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1056,'拨号计划列表(不分页)',204,6,'#',NULL,1,'F',0,0,'system:dialplan:list','','拨号计划列表(不分页)按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
-- 坐席管理按钮
(1057,'新增坐席',300,1,'#',NULL,1,'F',0,0,'system:agent:add','','新增坐席按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1058,'修改坐席',300,2,'#',NULL,1,'F',0,0,'system:agent:edit','','修改坐席按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1059,'删除坐席',300,3,'#',NULL,1,'F',0,0,'system:agent:delete','','删除坐席按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1060,'坐席详情',300,4,'#',NULL,1,'F',0,0,'system:agent:get','','坐席详情按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1061,'坐席列表',300,5,'#',NULL,1,'F',0,0,'system:agent:page:list','','坐席列表按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1062,'坐席签入',300,6,'#',NULL,1,'F',0,0,'system:agent:check:in','','坐席签入按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1063,'坐席签出',300,7,'#',NULL,1,'F',0,0,'system:agent:check:out','','坐席签出按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1064,'坐席忙碌',300,8,'#',NULL,1,'F',0,0,'system:agent:check:busy','','坐席忙碌按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0),
(1065,'坐席通话中',300,9,'#',NULL,1,'F',0,0,'system:agent:check:calling','','坐席通话中按钮',1,'2024-07-15 10:43:17.0',NULL,NULL,0);
